...
export const LLM_ROUTE_ENV: Record<LlmFeature, string> = {
  ...
  narrative_summary: "LLM_ROUTE_NARRATIVE_SUMMARY",
  insight_synthesis: "LLM_ROUTE_INSIGHT_SYNTHESIS",
...
const PROMPT_KEY_TO_FEATURE: Record<string, LlmFeature> = {
  ...
  narrative_summary_prompt: "narrative_summary",
  insight_synthesis_prompt: "insight_synthesis",
